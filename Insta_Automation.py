...
def instagram():
    ...
    target_username = input1.get()

    your_username = input2.get()

    your_password = input3.get()


    SIMILAR_ACCOUNT = target_username # Change this to an account of your choice
...
mylabel = Label(text = "Target Account Username: ")
mylabel.pack()

input1 = Entry()
input1.pack()

mylabel = Label(text = "Your Username: ")
mylabel.pack()

input2 = Entry()
input2.pack()

mylabel = Label(text = "Your Password")
mylabel.pack()

input3 = Entry()
input3.pack()

button = Button(text="Run",command=instagram)
button.pack()
